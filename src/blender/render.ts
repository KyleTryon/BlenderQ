  ...
  return new Promise((resolve, reject) => {
    const child = spawn(
      ...
      [
        ...
        blendFile,
        '--factory-startup',
        '--python', scripts.renderTask,
        '--',
        '--outDir', task.renderPath,
        '--pattern', task.renderFilename,
        '--ext', task.renderExtension,
        '--start', '1',                // or task.startFrame
        '--end',   String(task.frames) // etc.
      ],
    ...
    readline.createInterface({ input: child.stdout })
      .on('line', (line) => {
        ...
        } catch { /* ignore non‑JSON Blender chatter */ }
      })
